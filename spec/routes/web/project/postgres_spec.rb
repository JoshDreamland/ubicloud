...
RSpec.describe Clover, "postgres" do
  ...
  describe "authenticated" do
    ...
    describe "create" do
      ...
      it "shows storage architecture cards when the network cache flag is enabled" do
        project.set_ff_private_locations(true)
    ...
    describe "show" do
      ...
      it "shows connection information if the resource is running" do
        ...
        # Show correct information for hostname version v3 with publicly signed certificates

...
#  rekey_protocol    | integer                  | NOT NULL DEFAULT 1
# Indexes:
...
#  rekey_protocol_check                   | (rekey_protocol = ANY (ARRAY[1, 2]))
...
#  gcp_vpc                     | gcp_vpc_dedicated_for_subnet_id_fkey             | (dedicated_for_subnet_id) REFERENCES private_subnet(id)
